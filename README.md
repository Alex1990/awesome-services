...
The top global cloud computing platforms.

**This category should be stay on top.**

* [Alibaba Cloud](https://www.alibabacloud.com/) - Alibaba Cloud, founded in 2009, is a global leader in cloud computing and artificial intelligence, providing services to thousands of enterprises, developers, and governments organizations in more than 200 countries and regions.
...
* [Tencent Cloud](https://intl.cloud.tencent.com/) - China’s leading public cloud service provider with secure and reliable cloud products and solutions.
...
* [Alibaba Cloud CDN](https://www.alibabacloud.com/product/cdn) - A scalable and high-performance content delivery service for accelerated distribution of content to users across the globe.
...
* [Alibaba Cloud Computing](https://www.alibabacloud.com/) - Virtual server, containers, and serverless.
...
* [Tencent Cloud Compute](https://intl.cloud.tencent.com/) - Virtual machines, containers, GPUs.
...
* [Tencent Cloud Databases](https://intl.cloud.tencent.com/product/cdb) - A high-performance, high-reliability, flexibly scalable database hosting service.
...
* [Alibaba Cloud OSS](https://www.alibabacloud.com/product/oss) - An encrypted and secure cloud storage service that can store, process, and access massive amounts of data from anywhere in the world.
...
* [DingTalk](https://www.dingtalk.com/) - The most porpular company communication and collabration tool in China, powered by Alibaba.
